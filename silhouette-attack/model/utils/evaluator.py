...
def evaluation_A(data, config):
    dataset = config['dataset'].split('-')[0]
    feature, typeandview, label = data
    label = np.array(label)
    view = []
    seq_type = []
    for tv in typeandview:
        #t = tv.split('_')[1]
        v = tv.split('_')[0]
        view.append(v)
        seq_type.append(tv)
    ...
    probe_seq_dict = {'CASIA': [['00_1','00_2','00_3'],['45_1','45_2','45_3'],['90_1','90_2','90_3']],#[['1'],['2'],['3']],
                      'OUMVLP': [['00']]}
    gallery_seq_dict = {'CASIA': [['00_4','45_4','90_4']],#[['4']],
                        'OUMVLP': [['01']]}
